...
class DiscoverMovieRepositoryTest {
    ...
    @MockK
    lateinit var currentWeatherRemoteDataSource: CurrentWeatherRemoteDataSourceInterface
    ...
    fun getMovieDetailById_Successfull() {
        ...
        every { currentWeatherRemoteDataSource.getMovieDetailById(any()) } returns testObservable
        // /Action
    ...
    fun getMovieDetailById_Failed() {
        ...
        every { currentWeatherRemoteDataSource.getMovieDetailById(any()) } returns Single.error(
