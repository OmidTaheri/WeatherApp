...
-keepclasseswithmembers class ir.omidtaheri.mainpage.entity.forecastEntity.forecastList
-keepnames class ir.omidtaheri.mainpage.entity.forecastEntity.forecastList
